# Módulo 01 – Fundamentos da Programação
...
- **Fase 01 – Lógica de Programação:** variáveis, tipos, operadores, estruturas de controle e funções.
- **Fase 02 – Algoritmos e Pseudocódigo:** raciocínio algorítmico e representação de problemas.
...
1. **Teoria completa** – explicação detalhada com exemplos em JavaScript.
2. **Quiz** – questões para fixação do conteúdo.
...
- Use os quizzes e exercícios para testar seu conhecimento.
- Complete os desafios para se preparar para situações reais de trabalho.
